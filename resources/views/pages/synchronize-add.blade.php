    ...
    <div class="col-12 grid-margin">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-sample" action="{{ route('synchronize-save') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="hidden" class="form-control text-white" name="command"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control text-white" name="source_connection"
                                        value="{{ old('source_connection') }}" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control text-white" name="target_connection"
                                        value="{{ old('target_connection') }}" required />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control text-white" name="target_table"
                                        value="{{ old('target_table') }}" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-control text-white bg-dark text-warning" id="query"
                                        name="query" rows="4" required>{{ old('query') }} </textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-sm btn-inverse-success mr-2">Submit</button>
                    <button class="btn btn-sm btn-inverse-danger">Cancel</button>
